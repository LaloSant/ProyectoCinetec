...
public class AsientosNormController implements Initializable
{
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
        ...
        if (LocalDate.now().getDayOfWeek() == DayOfWeek.MONDAY)
        {
            ...
            {
                System.out.println("Son mas de las 11 y menos de las 13");
                descLunes = true;
            }
        }
        if (descLunes == true)
    ...
    private void btnAgregar(ActionEvent event)
    {
        ...
        } else
        {
            if (tipoSala.equalsIgnoreCase("VIP"))
            {
                ...
                if (descMiercoles == false && descLunes == false)
                {
                    total += PVIP;
                }
            } else
            {
                ...
                System.out.println(txtmiercoles);
                if (descLunes == true)
                {
                    total += (PNORMAL - (PNORMAL * 0.3));
                }
                if (descLunes == false && descMiercoles == false)
                {
                    total += PNORMAL;
                }
            }
